<?php
    ...
    if(isset($_POST["input"])){
            $tanggal = $_POST["tanggalupload"];
            $judul = $_POST["judul"];
            $rincian = $_POST["rincian"];
            $berkas = $_FILES["gambar"]["name"];

            
            $tbh = $dd->tambahpengumuman($tanggal, $judul, $rincian,  $berkas);
            
            if($tbh){
                //$pesan = "Data Berhasil di tambahkan";
                $jud =  "<center><b><h2>".$judul."</h2></b></center>";
                    ...
                    <?php
                      ...
                      //  }
                        ...
                        if(copy($filesementara, "images/$namafile"))
                        {
                            ...
                            $hasil = $dd->getpengumuman($namafile);
