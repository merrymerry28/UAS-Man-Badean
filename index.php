<?php
    ...
    $db = new pengumuman;
    $tampilpengumuman = $db->getpengumuman();
    $fotopengumuman = $db->getfotopengumuman();
		...
		<body bgcolor='black'>
			<table border="7" align="center" width="1200" cellspacing="15" cellpadding="25">
				...
				<tr align="center" valign ="top" width='1000' height='350' background="sma-1024x720.png">
                    <center><td colspan ="15" height="300"><font face="broadway" size="7" ><b></b></font></td></center>
                    <center><h5> <i>MADRASAH ALIYAH NURUL HUDA BADEAN BANYUWANGI</i></h5></center></tr>
                <tr width='1200'>
                    <td bgcolor="#F0F5FA" width="400" height="500" valign="top">
                        <b><h2>Recent Berita Acara</h2></b>
                        <br><br>
                        
                        <?php
                            while($ff = $tampil->fetch_array()){
                            ?>
                        <a href="artikelevent.php?idevent=<?php echo $ff["idevent"]; ?>"><?php echo $ff["judul"]."<br><br>"; ?></a>
                        ...
                        <td bgcolor="#F0F5FA" >
                            <?php
                                 while($fas = $tampilpengumuman->fetch_array()){
                            ?>
                            
                                                       
                           <?php echo "<center><b><h2>".$fas["judul"]."</b></h2></center><br>";
                                
                            echo "<h4><p style='text-align:justify;'/>".$fas["rincian"]."</h4><br><br><br>";?>
                            
                            <?php echo "<center><IMG SRC ='images/".$fas['gambar']."' width='275px' height='275spx'/></center><br><br><br>"; ?> 
