                ...
                <td bgcolor="#EEF2F7">
                    <h2>Data Prestasi MA Nurul Hidayah Badean</h2>
                            ...
                            <table border=1>
                                ...
                                $no = 0;
                                while ($ev = $data->fetch_array()){
                                    ?>
                                    <tr>
                                    <td><?php echo ++$no; ?></td>
                                    <td><?php echo $ev["tanggalupload"]; ?></td>
                                    <td><?php echo $ev["judul"]; ?></td>
                                    <td><?php echo $ev["rincian"]; ?></td>
                                    <td><?php echo $ev["gambar"]; ?></td>
