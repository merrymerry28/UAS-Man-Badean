<?php
    ...
    //if(isset($_POST["tahun"],$_POST["nama_prestasi"],$_POST["tangga         l"],$_POST["tingkat"],$_POST["kelompok/individu"],               $_POST["nama_prestasi"])){
        if(isset($_POST["input"])){
            ...
            $tbh = $dd->tambahprestasi($tahun, $nama_prestasi, $tingkat, $kelompokindividu, $nama_peserta);
