<?php
    ...
    if(isset($_POST["hapus"])){
        $dlt = $dd->hapusfasilitas($id);
        
        if($dlt){
            
             header ("Location: backfasilitas.php");
        }
        else{
                ...
                <td bgcolor="#EEF2F7">
                    <h2>Data Prestasi MA Nurul Hidayah Badean</h2>
                            ...
                            <table border=1>
                                ...
                                $no = 0;
                                while ($fas = $data->fetch_array()){
                                    ?>
                                    <tr>
                                    <td><?php echo ++$no; ?></td>
                                    <td><?php echo $fas["nama"]; ?></td>
                                    <td><?php echo $fas["rincian"]; ?></td>
                                    <td><?php echo $fas["gambar"]; ?></td>
