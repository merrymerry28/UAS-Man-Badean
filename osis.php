			...
			<table border="7" align="center" width="1200" cellspacing="15" cellpadding="25">
                ...
                <tr>
                    <td bgcolor="#F0F5FA" width="400" height="500" valign="top">
                        <b><h2><center>Daftar Anggota Osis MA Nurul Huda Badean</center></h2></b>
                        <br><br>
                        <table border=0>
                                
                                <?php
                                //$no = 0;
                                while ($osis = $os->fetch_array()){
                                    ?>
                                    <tr>
                                    
                                    <td><b><?php echo  $osis["jabatan"]; ?></b></td>
                                    <td><b>:</b> <?php echo $osis["namaosis"]; ?></td>
