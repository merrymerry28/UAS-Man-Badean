			...
			<table border="7" align="center" width="1200" cellspacing="15" cellpadding="25">
                ...
                <tr>
                    <td bgcolor="#F0F5FA" width="400" height="500" valign="top">
                        <b><h2><center>Fasilitas MA Nurul Huda Badean</center></h2></b>
                        <br><br>
                        <center><table  cellpadding="10">
                        <?php
                            while($fas = $tampil->fetch_array()){
                            ?>
                        <tr>
                            <td><?php echo "<center><IMG SRC ='images/".$fas['gambar']."' width='275px' height='275spx'/></center><br><br><br>"; ?></td>
                            <td><?php echo "<center><b><h2>".$fas["nama"]."</center></b></h2><br>";
                                
                            echo "<h4>".$fas["rincian"]."</h4><br><br><br>";?></td></tr>
