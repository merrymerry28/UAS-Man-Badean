...
<html>
    ...
    <body bgcolor="#01FCEF">
        	<align="center" border="0"  width="1360" cellspacing="2" cellpadding="10">
        ...
        <table align="center" cellpadding="10" width ="1300" >
            ...
            <tr>
                ...
                <td bgcolor="#EEF2F7">
                    ...
                    <form action="backfotoinfo.php"  method="post"  enctype="multipart/form-data"  >
                    <table border="2" cellpadding="10"> 
                        ...
                        <tr>
                            ...
                            <td><input name="tanggalupload" type="date"></td>
                        </tr>
                        <tr>
                    ...
                    <?php
                        if($tambah === FALSE){
                            ...
                            <table border=1>
                                ...
                                <?php
                                $no = 0;
                                while ($event = $tambah->fetch_array()){
                                    ?>
                                    <tr>
                                    <td><?php echo ++$no; ?></td>
                                    <td><?php echo $event["judul"]; ?></td>
                                    <td><?php echo $event["rincian"]; ?></td>
                                    <td><?php echo $event["tanggalupload"]; ?></td>
                                    <td><?php echo $event["gambar"]; ?></td>
                                    <td><a href="editinfo.php?idevent=<?php echo $event["idevent"]; ?>">Ubah</a> | <a href="hapusinfo.php?idevent=<?php echo $event["idevent"]; ?>">Hapus</a></td>
                                </tr>
                                <?php
                                }
                                ?>
